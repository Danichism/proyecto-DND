...
if __name__=="__main__":
    decision=funciones_auxiliares.crear_menu(["Crear un objeto arma", "Salir"], "¿Qué desea hacer?")
    if decision=="Crear un objeto arma":      
        ...
        if arma_escogida:
            print (f"El arma es {arma_escogida}. Tiene un peso de {arma_escogida.peso}")
            print(f"Has hecho {arma_escogida.calcular_daño()} puntos de daño")
        else:
            print("No hay armas en la lista o el archivo de armas no existe o está dañado")   
    elif decision=="Salir":
